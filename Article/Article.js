...
function createPanel(title, date, firstParagraph, secondParagraph, thirdParagraph) {
	...
	panel.append(panelTitle, panelDate, panelp1, panelp2, panelp3, panelButton);
...
data.map(item => {
	articles.append(createPanel(item.title, item.date, item.firstParagraph, item.secondParagraph, item.thirdParagraph));
});
